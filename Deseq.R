...
workDir<-("~/mydata/case-study")

#####CHANGE THE TITLE DEPENDING ON TIME!! "all" "4hr" "12hr" AND "48hr"####
projectName <- "DietvsWorm2"

author <- "Sophie Fox-Gmuer"     # Author name for documentation purposes

###EDIT FILE PATH SECTION BELOW and TARTGET TILE NAME TO GET OUTPUTS FOR "4hr" "12hr" AND "48hr" for all leave it as "Targets.txt####

targetFile <- "~/mydata/case-study/featureCounts2/Targets2.txt"  # Path to the experimental design file

##### Change path to count files and change rawdir to the count folder you created in bash coinciding with the count data file
# "all" "4hr" or "12hr" or "48hr"
rawDir <- "~/mydata/case-study/featureCounts2"  # Directory containing raw count data files 
